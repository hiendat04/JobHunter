...
public class OpenApiConfig {
    ...
    private Contact createContact() {
        return new Contact()
                ...
                .name("Hien Dat")
                .url("https://github.com/hiendat04c");
    }
    ...
    private Info createApiInfo() {
        return new Info()
                ...
                .description("This API exposes all endpoints of Job Hunter App")
    ...
    public OpenAPI myOpenAPI() {
        return new OpenAPI()
                ...
                .servers(List.of(
                        ...
                        createServer("https://github.com/hiendat04c", "Server URL in Development environment")))
